...
#descriptives
summary(rawMobility)
write.csv(rawMobility, file = "rawMobility.csv", row.names = TRUE)
...
#secifying the imputation method (e.g. predictive mean matching)
impute_method <- mice(finalCleanedIVs, method = "sample")

#extracting the completed dataset with imputed values
...
#making infinite values and Naans just read as NAs # do on rated actually??
